...
async function abrirDetalheCliente(id) {
    ...
    openModal(`
        ...
        ${totalDevendo > 0 ? `
            <div class="card" style="border-left: 4px solid var(--warning); cursor: pointer;" onclick="closeModal(); navigateTo('cobrancas'); setTimeout(()=>{switchTabCobranca('todos'); filtrarCobrancasPorCliente(${id}); setTimeout(expandirTodosCollapses, 600);}, 400);">
